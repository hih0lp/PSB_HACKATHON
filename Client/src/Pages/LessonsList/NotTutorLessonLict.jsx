...
export default function NonTutorLessonList(){
    ...
    useEffect(()=>{
        async function fetchData() {
            try {
                ...
                const response = await fetch(`https://psbsmartedu.ru/courses/get-not-tutor-courses/${userId}`)
        ...
        return (
            <App>
                <section className="LessonList">
                    <Header headerText='Курсы, на которых вы обучаетесь'/>
